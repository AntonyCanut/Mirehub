...
export interface DefaultProfile {
  ...
  name: string
  description: string
  category: 'Quality' | 'Development' | 'Security' | 'Design' | 'Planning' | 'Documentation'
  content: string
  filename: string
}

const PROFILES_EN: DefaultProfile[] = [
  {
    id: 'code-reviewer',
    name: 'Code Reviewer',
...
const PROFILES_FR: DefaultProfile[] = [
  {
    id: 'code-reviewer',
    name: 'Revue de code',
...
export const DEFAULT_PROFILES: Record<Locale, DefaultProfile[]> = {
  en: PROFILES_EN,
  fr: PROFILES_FR,
}
